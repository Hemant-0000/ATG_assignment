...
function Header({ setOnSignUp, onSignUp, onSignIn }) {
    ...
    return (
        <>
            ...
            <div id='header' className={`header ${(onSignUp || onSignIn) ? 'backdrop-blur-sm' : ''} w-[360px] h-[236px] mb-[66px] bg-[url('../public/assets/cardimage/headerbg.png')] bg-no-repeat bg-cover w-full `}>
                ...
                <h3 className='absolute top-[164px] left-[16px] w-[179px] h-[22px] font-[800] font-IBM text-[17px] leading-[22.1px] text-white sm:left-[30px] sm:text-[19px] sm:w-[200px]  md:left-[80px] md:text-[22px] md:w-[250px] md:top-[236px] '>Computer Engineering</h3>
                <p className='w-[218px] h-[16px] absolute top-[188px] left-[16px] font-IBM font-[400] text-[12px] leading-[16px] text-white sm:left-[30px] sm:top-[190px] sm:text-[13px] sm:w-[280px] md:left-[80px] md:text-[12px] md:leading-[10px] md:top-[268px] mb-[32px]'>142,765 Computer Engineers follow this</p>
                ...
                <div className='hidden md:inline-flex md:absolute md:top-[80px] md:mx-auto '>
                    ...
                    {/* All Posts(32) */}
                    <p className='w-[93px] h-[21px] absolute top-[258px] ml-[50px] font-IBM font-[500] text-[16px] leading-[21px] text-[#000000] '>All Posts(32)</p>

                    {/* Article */}
                    <p className='w-[47px] h-[21px] absolute top-[258px] ml-[163px] font-IBM font-[400] text-[16px] leading-[21px] text-[#8A8A8A]  '>Article</p>

                    {/* Events */}
                    <p className='w-[41px] h-[21px] absolute top-[258px] ml-[230px] font-IBM font-[400] text-[16px] leading-[21px] text-[#8A8A8A]  '>Event</p>


                    {/* Education */}
                    <p className='w-[41px] h-[21px] absolute top-[258px] ml-[291px] font-IBM font-[400] text-[16px] leading-[21px] text-[#8A8A8A]  '>Education</p>


                    {/* Job */}
                    <p className='w-[41px] h-[21px] absolute top-[258px] ml-[380px] font-IBM font-[400] text-[16px] leading-[21px] text-[#8A8A8A]  '>Job</p>


                    {/* Write a Post  */}
                    <button className='w-[133px] h-[36px] absolute top-[250px] ml-[490px] rounded-[4px] bg-[#EDEEF0]  '>
                    ...
                    {/* Join Group  */}
                    <button className='w-[125px] h-[36px] absolute top-[250px] ml-[630px] bg-[#2F6CE5] rounded-[4px]  '>
                    ...
                    {/* Partition Line  */}
                    <div className='w-[700px] mt-[12px] h-0 absolute top-[290px] ml-[50px] border-[1px] border-solid border-[#E0E0E0] '></div>

                    {/* Underline */}
                    <div className='w-[93px] h-0 absolute mt-[12px] top-[290px] ml-[50px] border-[1px] border-solid border-black '></div>
