...
function SignUp({ setOnSignUp, setOnSignIn }) {
    return (
        <>
            ...
            {/* for small devices  */}
            <div className='md:hidden create-account z-50 w-[360px] h-screen transition ease-in duration-[8000ms] translate-y-[-15px] absolute top-[178px] bg-white md:top-[24px] md:left-[36px] '>
