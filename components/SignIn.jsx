    ...
    return (
        <>
            <div className='create-account w-[360px] h-[462px] absolute top-[178px] bg-white '>
                ...
                <Link href={'/sign-up'}>
                    <p className='w-[110px] h-[17px] absolute top-[175px] left-[230px] font-IBM font-[600] text-[13px] leading-[17px] text-center text-[#495057] underline cursor-pointer'>or, Create Account</p>
                </Link>
