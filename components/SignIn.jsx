...
function SignIn({ setOnSignIn, setOnSignUp }) {
    return (
        <>
            ...
            <div className='hidden md:inline-flex z-50 w-[736px] h-[457px] absolute top-[186px] left-[15px] rounded-[8px] bg-white shadow-acc-shadow lg:left-[150px] lg:top-[186px] xl:left-[352px] '>
